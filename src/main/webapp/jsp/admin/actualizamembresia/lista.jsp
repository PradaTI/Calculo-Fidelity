        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="../../../jspf/template-based/content-header.jspf" flush="false">
                    <jsp:param name="title" value="Actualizar membresias"/>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table id="fileMembresiaTable" class="table table-bordered table-striped responsive display" style="width:100%">
                                        ...
                                        <tbody>
                                            <c:forEach items="${membresiaFileList}" var="file">
                                                <tr>
                                                    <td>${file.id}</td>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${file.importedUser==null}">
                                                                ...
                                                                <c:if test="${not empty file.logFileList}">
                                                                    <a href="admin/actualizamembresia/logs/${file.id}" class="btn btn-xs btn-primary">Ver Logs</a>
                                                                    &nbsp;
                                                                </c:if>
                                                            </c:when>
                                                            <c:otherwise>
