        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="../../../jspf/template-based/content-header.jspf" flush="false">
                    <jsp:param name="title" value="Cliente Integración"/>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header bg-primary">
                                    <h3 class="card-title">${edit == false ? 'Nuevo Cliente Integración':'Editar Cliente Integración'}</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form:form method="post" modelAttribute="clienteIntegracionForm" class="form-horizontal" >
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="id" class="col-sm-3 col-form-label">Id</label>
                                            <div class="col-sm-9">
                                                <form:input path="id" class="form-control" placeholder="Id" disabled="true"/>
                                            </div>
                                            <div class="col-sm-9 offset-sm-3 float-right"><form:errors path="id" class="text-danger"/></div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="cliente" class="col-sm-3 col-form-label">Nombre Cliente</label>
                                            <div class="col-sm-9">
                                                <form:input path="cliente" class="form-control" placeholder="Nombre cliente"/>
                                            </div>
                                            <div class="col-sm-9 offset-sm-3 float-right"><form:errors path="cliente" class="text-danger"/></div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
