...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-navbar-fixed">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="../../../jspf/template-based/content-header.jspf" flush="false">
                    <jsp:param name="title" value="Archivos Transacciones gift cards"/>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header " >
                                    <h3 class="card-title float-right" >
                                        <a class="btn btn-block btn-secondary" href="admin/transaccionesgiftcards/add">Nuevo Archivo</a>
                                    </h3>
                                </div>
                                <div class="card-body ">
                                    ...
                                    <table id="fileTransaccionesGiftCardTable" class="table table-bordered table-striped responsive display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Archivo</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${transaccionesGiftcardFileList}" var="file">
                                                <tr>
                                                    <td>${file.id}</td>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${file.importedUser==null}">
                                                                ...
                                                                <c:if test="${not empty file.logFileList}">
                                                                    <a href="admin/transaccionesgiftcards/logs/${file.id}" class="btn btn-xs btn-primary">Ver Logs</a>
                                                                    &nbsp;
                                                                </c:if>
                                                            </c:when>
                                                            <c:otherwise>
        ...
        <script>
            ...
            $(function () {
                $('#fileTransaccionesGiftCardTable').DataTable({
                    'paging': true,
                    'lengthChange': true,
                    'searching': true,
                    'ordering': true,
                ...
                $('#modal-import').on('show.bs.modal', function (event) {
                    ...
                    modal.find('#action-import').attr('href', 'admin/transaccionesgiftcards/import/' + recordId);
                });
