        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="../../../jspf/template-based/content-header.jspf" flush="false">
                    <jsp:param name="title" value="Archivo transacciones gift cards"/>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header bg-primary">
                                    <h3 class="card-title">${edit == false ? 'Nuevo Archivo de gift cards':'Editar Archivo de gift cards'}</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="admin/transaccionesgiftcards/upload" class="form-horizontal" enctype="multipart/form-data" >
                                    <div class="card-body">
